...
COMMENT ON COLUMN inquiry_details.criteria_original IS 'the criteria xml snippet as received from source';
COMMENT ON COLUMN inquiry_details.criteria_modified IS 'if the original criteria had unknown keys which were removed...keep the modified one as well';
