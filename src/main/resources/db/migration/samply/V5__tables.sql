...
values ('QUALITY_REPORT_MDR_GROUPS', 'urn:dktk:dataelementgroup:7:latest;urn:dktk:dataelementgroup:8:latest', false);

INSERT INTO samply.configuration(name, setting, visible)
values ('QUALITY_REPORT_ADDITIONAL_MDR_DATA_ELEMENTS',
        'urn:adt:dataelement:77:1, urn:adt:dataelement:78:1, urn:adt:dataelement:89:1, urn:adt:dataelement:90:1, urn:adt:dataelement:91:1, urn:adt:dataelement:93:1',
        false);

INSERT INTO samply.configuration(name, setting, visible)
values ('QUALITY_REPORT_MDR_NAMESPACE', 'dktk, adt', false);
INSERT INTO samply.configuration(name, setting, visible)
values ('QUALITY_REPORT_MDR_AUTH_USER_ID', '20', false);
INSERT INTO samply.configuration(name, setting, visible)
values ('QUALITY_REPORT_MDR_AUTH_KEY_ID', '2', false);
INSERT INTO samply.configuration(name, setting, visible)
values ('QUALITY_REPORT_MDR_AUTH_URL', 'https://auth.ccp-it.dktk.dkfz.de', false);
INSERT INTO samply.configuration(name, setting, visible)
values ('QUALITY_REPORT_MDR_AUTH_PRIVATE_KEY_BASE_64',
...
INSERT INTO samply.configuration(name, setting, visible)
values ('MDR_SOURCE_GROUPS',
        'urn:dktk:dataelementgroup:7:latest;urn:dktk:dataelementgroup:8:latest;urn:adt:dataelementgroup:17:latest',
        false); -- for versions beyond CentraXX 3.9.0
-- INSERT INTO samply.configuration(name, setting, visible) values('MDR_SOURCE_GROUPS', 'urn:dktk:dataelementgroup:7:latest;urn:dktk:dataelementgroup:8:latest', false); -- for versions before CentraXX 3.9.0


INSERT INTO samply.configuration(name, setting, visible)
values ('QUALITY_REPORT_CENTRAXX_VALUES_FILE', 'centraxx.values.txt', false);
DELETE
FROM samply.configuration
WHERE name = 'QUALITY_REPORT_CENTRAXX_ATTRIBUTES_FILE';

DELETE
FROM samply.configuration
WHERE name = 'QUALITY_REPORT_NAMESPACE';
DELETE
FROM samply.configuration
WHERE name = 'QUALITY_REPORT_AUTH_USER_ID';
DELETE
FROM samply.configuration
WHERE name = 'QUALITY_REPORT_AUTH_KEY_ID';
DELETE
FROM samply.configuration
...
DELETE
FROM samply.configuration
WHERE name = 'QUALITY_REPORT_AUTH_PRIVATE_KEY_BASE_64';
