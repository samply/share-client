 ...
 *
 *  07.10.2015: Modified by Michael: Use seconds for sorting as well (set to 00 if omitted)
 *
...
jQuery.extend(jQuery.fn.dataTableExt.oSort, {
  "de_datetime-asc": function (a, b) {
    ...
    if (jQuery.trim(a) !== '') {
      ...
      x = (deDatea2[2] + deDatea2[1] + deDatea2[0] + deTimea[0] + deTimea[1]
          + deTimea[2]) * 1;
    } else {
    ...
    if (jQuery.trim(b) !== '') {
      ...
      y = (deDateb[2] + deDateb[1] + deDateb[0] + deTimeb[0] + deTimeb[1]
          + deTimeb[2]) * 1;
    } else {
      y = Infinity;
    }
