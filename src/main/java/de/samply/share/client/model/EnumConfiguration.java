...
public enum EnumConfiguration {
  ...
  MONITORING_REPORT_LDM_CERTIFICATE_DATE,
  LDM_CACHING_ENABLED,
  ...
  CTS_SEARCH_ID_TYPE,
  CTS_PATIENT_LIST_API_KEY,
  CTS_PATIENT_LIST_URL,
  CTS_CRYPT_KEY,
  LDM_URL_BASE,
  CENTRAL_MDS_DATABASE_WHITELIST,
  PROJECT_DIRECTORY_URL,
  PATIENTLIST_URL,
  PROJECT_PSEUDONYMISATION_URL,
  PROJECT_PSEUDONYMISATION_URL_CHECK,
  EXPORT_WORKBOOK_WINDOW,
  EXPORT_TIMEOUT_IN_MINUTES
}
