 ...
 * generated in the de.samply.share.client.model.common package. 
...
public class ObjectFactory {
    ...
    private final static QName _Operator_QNAME = new QName("http://schema.samply.de/common", "operator");
    private final static QName _Urls_QNAME = new QName("http://schema.samply.de/common", "urls");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.samply.share.client.model.common
     * 
     */
