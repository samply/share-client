...
public class LdmConnectorCentraxx implements LdmConnector<QueryResult, Patient> {
    ...
    public String postQuery(Query query,
        ...
        try {
            ...
            ViewFields viewFields = getViewFields(completeMdsViewFields, includeAdditionalViewfields);
            logViewFields(viewFields); //TODELETE
    ...
    private void logViewFields(ViewFields viewFields){

        StringBuilder stringBuilder = new StringBuilder();
        for (String mdrId : viewFields.getMdrKey()){
