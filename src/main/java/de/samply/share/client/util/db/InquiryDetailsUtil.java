...
public class InquiryDetailsUtil {
    ...
    public static int insertInquiryDetails(InquiryDetails inquiryDetails) {
        ...
        InquiryDetailsRecord inquiryDetailsRecord = dslContext.newRecord(Tables.INQUIRY_DETAILS, inquiryDetails);
     ...
     * @return the set of inquiry details
     */
    public static InquiryDetails getInquiryDetailsForInquiryWithRevision(Inquiry inquiry, int revision) {
        DSLContext dslContext = ResourceManager.getDSLContext();
        return dslContext
    ...
    public static List<InquiryDetails> getInquiryDetailsOlderThanDays(int thresholdDays) {
        ...
        return dslContext
                .selectFrom(Tables.INQUIRY_DETAILS)
                .where(
                        DSL.currentTimestamp().greaterThan(DSL.timestampAdd(Tables.INQUIRY_DETAILS.RECEIVED_AT, thresholdDays, DatePart.DAY))
