...
public class EventLogUtil {
    ...
    public static void insertEventLogEntry(EventMessageType messageType, String... params) {
        ...
        eventLog.setEntry(createJsonEventLogEntry(null, null, null, new ArrayList<>(Arrays.asList(params))));
     ...
     * @param params parameters that will be substituted via resource bundle and messageformat
     */
    public static void insertEventLogEntryForInquiryId(EventMessageType messageType, int inquiryId, String... params) {
        EventLog eventLog = new EventLog();
        eventLog.setEntry(createJsonEventLogEntry(null, null, null, new ArrayList<>(Arrays.asList(params))));
     ...
     * @param params parameters that will be substituted via resource bundle and messageformat
     */
    public static void insertEventLogEntryForUploadId(EventMessageType messageType, int uploadId, String... params) {
        EventLog eventLog = new EventLog();
        eventLog.setEntry(createJsonEventLogEntry(null, null, null, new ArrayList<>(Arrays.asList(params))));
        eventLog.setEventType(messageType);
     ...
     */
    private static String createJsonEventLogEntry(String message, String filename, String url, List<String> parameters) {
