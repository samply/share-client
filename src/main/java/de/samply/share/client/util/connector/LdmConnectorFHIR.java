...
import de.samply.common.ldmclient.samplystoreFHIR.LdmClientSamplystoreFHIRException;
...
public class LdmConnectorFHIR implements LdmConnector<BbmriResult, Patient> {
    ...
    public LdmConnectorFHIR(boolean useCaching) {
        try {
            init(useCaching);
            this.mdrClient = ApplicationBean.getMdrClient();
        } catch (LDMConnectorException e) {
    ...
    public LdmConnectorFHIR(boolean useCaching, int maxCacheSize) {
        try {
    ...
    private void init() throws LDMConnectorException {
        try {
            ...
            this.ldmClient = new LdmClientSamplystoreFHIR(httpClient, samplystoreBaseUrl);
    ...
    private void init(boolean useCaching) throws LDMConnectorException {
        try {
            ...
            this.samplystoreHost = SamplyShareUtils.getAsHttpHost(samplystoreBaseUrl);
            httpClient = httpConnector.getHttpClient(samplystoreHost);
            this.ldmClient = new LdmClientSamplystoreFHIR(httpClient, samplystoreBaseUrl, useCaching);
        } catch (MalformedURLException | LdmClientException e) {
            throw new LDMConnectorException(e);
        }
    }
    ...
    private void init(boolean useCaching, int maxCacheSize) throws LDMConnectorException {
        try {
            ...
            this.samplystoreHost = SamplyShareUtils.getAsHttpHost(samplystoreBaseUrl);
            httpClient = httpConnector.getHttpClient(samplystoreHost);
            this.ldmClient = new LdmClientSamplystoreFHIR(httpClient, samplystoreBaseUrl, useCaching, maxCacheSize);
        } catch (MalformedURLException | LdmClientException e) {
            throw new LDMConnectorException(e);
        }
    }
    ...
    public BbmriResult getResultsFromPage(String location, int page) throws LDMConnectorException {
        ...
        } catch (LdmClientSamplystoreFHIRException e) {
            throw new LDMConnectorException(e);
        }
    }
