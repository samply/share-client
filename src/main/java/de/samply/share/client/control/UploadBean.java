...
public class UploadBean implements Serializable {
     ...
     *
     * Depending on the setting of the switches on the page, spawn either an upload or dry run - a full or an incremental upload
     * and either upload patient datasets for patients with explicit dktk consent or those without that
     *
    ...
    public boolean isUploadNonDktkAllowed() {
        return ConfigurationUtil.getConfigurationElementValueAsBoolean(EnumConfiguration.CENTRAL_MDS_DATABASE_UPLOAD_PATIENTS_WITH_LOCAL_CONSENT);
    }
}
