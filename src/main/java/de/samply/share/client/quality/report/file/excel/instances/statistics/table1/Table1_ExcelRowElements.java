...
public class Table1_ExcelRowElements extends ExcelRowElements {
    ...
    public Table1_ExcelRowElements() {
    ...
    public void addDataElementGroup (String dataElementGroup){
        ...
        addElement(ELEMENT_ORDER.DATA_ELEMENTS_GROUP, stringExcelCellElement);
    ...
    public void addPercentrage (Double percentage){
        ...
        addElement(ELEMENT_ORDER.PERCENTAGE, doubleExcelCellElement);
