...
import de.samply.share.client.quality.report.chainlinks.timer.ChainLinkTimer_002;

public class ChainLinkTimerFactory_002 implements ChainLinkTimerFactory{

    private long maxTimeToWaitInMillis;

    public ChainLinkTimerFactory_002(long maxTimeToWaitInMillis) {
    ...
    public ChainLinkTimer createChainLinkTimer() {
        ...
        ChainLinkTimer_002 chainLinkTimer = new ChainLinkTimer_002();
