...
public class PostViewOnlyStatistics_ChainLink<I extends ChainLinkItem & ViewContext> extends PostView_ChainLink<I> {


    public PostViewOnlyStatistics_ChainLink(LocalDataManagementRequester localDataManagementRequester) {
    ...
    protected LocalDataManagementResponse getLocalDataManagementResponse(I chainLinkItem) throws ChainLinkException {
        ...
        try {
            return localDataManagementRequester.postViewAndGetLocationUrlStatisticsOnly(chainLinkItem.getView());
