...
public class QualityResultsSortedMdrIdsByDktkIdFilter extends QualityResultsSortedMdrIdsFilter<MdrIdComparatorByDktkId> {

    private MdrIdComparatorByDktkId mdrIdComparatorByDktkId;



    public QualityResultsSortedMdrIdsByDktkIdFilter(QualityResults qualityResults, DktkId_MdrId_Converter dktkIdManager) {
