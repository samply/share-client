...
public class DataElementStats_ExcelRowContextFactory {
    ...
    public DataElementStats_ExcelRowContext createExcelRowContext (QualityResults qualityResults, QualityResultsStatistics qualityResultsStatistics){

        return new DataElementStats_ExcelRowContext(qualityResults, qualityResultsStatistics, excelRowMapper);
