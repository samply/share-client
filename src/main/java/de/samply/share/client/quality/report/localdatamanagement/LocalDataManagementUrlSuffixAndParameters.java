...
public class LocalDataManagementUrlSuffixAndParameters {
    ...
    public final static String RESULTS_URL_SUFFIX = "result";

    public final static String STATISTICS_ONLY_PARAMETER = "statisticsOnly";
    public final static String PAGE_PARAMETER = "page";

    public final static String SQL_MAPPING_VERSION = "mapping";
