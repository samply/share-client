...
public class Validator_ChainLink<I extends ChainLinkItem & ValidatorContext> extends ChainLink<I> {

    private QualityResultsValidator qualityResultsValidator;

    public Validator_ChainLink(QualityResultsValidator qualityResultsValidator) {
