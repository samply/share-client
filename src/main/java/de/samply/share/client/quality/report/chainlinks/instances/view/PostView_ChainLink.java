...
public class PostView_ChainLink<I extends ChainLinkItem & ViewContext> extends LdmChainLink<I> {


    public PostView_ChainLink(LocalDataManagementRequester localDataManagementRequester) {
    ...
    protected I setToBeRepeated(I item, LocalDataManagementResponse localDataManagementResponse) {
        ...
        if (! (localDataManagementResponse.isSuccessful() || localDataManagementResponse.getStatusCode() == HttpStatus.SC_CREATED)){
