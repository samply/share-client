...
public class ChainLinkStaticStatistics  {
    ...
    private Map<ChainLinkStatisticKey, ChainLinkStaticStatisticsParameters> chainLinkStaticStatisticsParametersMap = new HashMap<>();


    public void put (ChainLinkStatisticKey chainLinkStatisticKey, ChainLinkStaticStatisticsParameters chainLinkStaticStatisticsParameters){

        chainLinkStaticStatisticsParametersMap.put(chainLinkStatisticKey, chainLinkStaticStatisticsParameters);
