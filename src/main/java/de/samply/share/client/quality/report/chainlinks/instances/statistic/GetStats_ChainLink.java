...
public class GetStats_ChainLink<I extends ChainLinkItem & StatisticContext> extends LdmChainLink<I> {


    public GetStats_ChainLink(LocalDataManagementRequester localDataManagementRequester) {
    ...
    protected I process(I chainLinkItem, LocalDataManagementResponse localDataManagementResponse) {
        ...
        QueryResultStatistic queryResultStatistic = getQueryResultStatistic(localDataManagementResponse);
...
//chainLinkItem.setMaxPages(0);
    ...
    private QueryResultStatistic getQueryResultStatistic (LocalDataManagementResponse<QueryResultStatistic> localDataManagementResponse){
