...
public class MetadataQualityReportFileWriter_ChainLink<I extends ChainLinkItem & FileContext> extends ChainLink<I> {
    ...
    public MetadataQualityReportFileWriter_ChainLink(QualityReportMetadataFileManager qualityReportMetadataFileManager, LocalDataManagementRequester localDataManagementRequester) {
    ...
    private String getSqlMappingVersion_withoutExceptionManagement() throws LocalDataManagementRequesterException {

        LocalDataManagementResponse<String> localDataManagementResponse = localDataManagementRequester.getSqlMappingVersion();
